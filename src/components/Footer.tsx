      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs uppercase tracking-[0.15em] text-gray-500">
            Library by{" "}
            <Link href="https://github.com/Emengkeng" className="hover:text-[#FFFACD] transition-colors underline underline-offset-2">
              Juslen
            </Link>
          </span>
        </div>
        ...
        <div className="flex items-center gap-5">
          {/* GitHub */}
          <Link href="https://github.com/eventop-s" target="_blank" className="text-gray-600 hover:text-[#FFFACD] transition-colors">
          ...
          {/* Twitter/X */}
          <Link href="https://twitter.com/tryEventop" target="_blank" className="text-gray-600 hover:text-[#FFFACD] transition-colors">
            <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
